...
// 基础类型
extern template Matrix<float>  ofec_decode_llr<float >(const Matrix<float>&,  const Params&, std::vector<TileEarlyStopCounter>*);
extern template Matrix<int8_t> ofec_decode_llr<int8_t>(const Matrix<int8_t>&, const Params&, std::vector<TileEarlyStopCounter>*);

extern template void process_window<float >(Matrix<float>&,  const Matrix<float>&,
                                            std::size_t, std::size_t, const Params&,
                                            std::size_t, std::size_t, std::size_t,
                                            std::vector<TileEarlyStopCounter>*);
extern template void process_window<int8_t>(Matrix<int8_t>&, const Matrix<int8_t>&,
                                            std::size_t, std::size_t, const Params&,
                                            std::size_t, std::size_t, std::size_t,
                                            std::vector<TileEarlyStopCounter>*);

extern template TileProcessResult<float>  process_tile<float >(const Matrix<float>&,  const Matrix<float>&,
                                                               const Params&, std::size_t, bool);
extern template TileProcessResult<int8_t> process_tile<int8_t>(const Matrix<int8_t>&, const Matrix<int8_t>&,
                                                               const Params&, std::size_t, bool);

// qfloat 量化类型（按需开启）
extern template Matrix<newcode::qfloat<4>> ofec_decode_llr<newcode::qfloat<4>>(const Matrix<newcode::qfloat<4>>&,
                                                                              const Params&, std::vector<TileEarlyStopCounter>*);
extern template Matrix<newcode::qfloat<5>> ofec_decode_llr<newcode::qfloat<5>>(const Matrix<newcode::qfloat<5>>&,
                                                                              const Params&, std::vector<TileEarlyStopCounter>*);
...
extern template TileProcessResult<newcode::qfloat<4>> process_tile<newcode::qfloat<4>>(const Matrix<newcode::qfloat<4>>&,
                                                                                       const Matrix<newcode::qfloat<4>>&,
                                                                                       const Params&, std::size_t, bool);
