...
// 基础类型
extern template Matrix<float>  ofec_decode_llr<float >(const Matrix<float>&,  const Params&, std::vector<TileEarlyStopCounter>*, bool);
extern template Matrix<int8_t> ofec_decode_llr<int8_t>(const Matrix<int8_t>&, const Params&, std::vector<TileEarlyStopCounter>*, bool);
