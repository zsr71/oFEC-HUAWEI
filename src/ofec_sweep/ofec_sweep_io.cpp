...
void ensure_csv_header(const std::string& csv_path) {
  ...
  fout << "timestamp,run_id,scenario,decoder_name,"
          ...
          "chase_L,chase_n_test,chase_topk_keep,chase_group_minima_bits,mux_group_g,mux_group_g_list,mux_scheduling_mode,mux_early_stop_priority_rule,mux_bypass_scheme,bitgen_seed,channel_seed,ebn0_db,ALPHA_LIST,beta_list,"
