...
#define INSTANTIATE_CHASE256_EBCH_QFLOAT(N) \
...
INSTANTIATE_CHASE256_EBCH_QFLOAT(2)
INSTANTIATE_CHASE256_EBCH_QFLOAT(3)
INSTANTIATE_CHASE256_EBCH_QFLOAT(4)
INSTANTIATE_CHASE256_EBCH_QFLOAT(5)
INSTANTIATE_CHASE256_EBCH_QFLOAT(6)
INSTANTIATE_CHASE256_EBCH_QFLOAT(7)
INSTANTIATE_CHASE256_EBCH_QFLOAT(8)
INSTANTIATE_CHASE256_EBCH_QFLOAT(9)
INSTANTIATE_CHASE256_EBCH_QFLOAT(10)
INSTANTIATE_CHASE256_EBCH_QFLOAT(11)
INSTANTIATE_CHASE256_EBCH_QFLOAT(12)
INSTANTIATE_CHASE256_EBCH_QFLOAT(13)
INSTANTIATE_CHASE256_EBCH_QFLOAT(14)
INSTANTIATE_CHASE256_EBCH_QFLOAT(15)

#undef INSTANTIATE_CHASE256_EBCH_QFLOAT
