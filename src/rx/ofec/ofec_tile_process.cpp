...
// ===== 显式实例化 =====
template TileProcessResult<float>  process_tile_plain<float >(const matrix::Matrix<float>&,  const matrix::Matrix<float>&,  const Params&, size_t, bool, bool, const matrix::Matrix<float>*);
template TileProcessResult<float>  process_tile_ebchPF<float >(const matrix::Matrix<float>&,  const matrix::Matrix<float>&,  const Params&, size_t, bool, bool, const matrix::Matrix<float>*);
...
template TileProcessResult<qfloat::qfloat<N>> process_tile_plain<qfloat::qfloat<N>>( \
    ...
    const Params&, size_t, bool, bool, const matrix::Matrix<float>*); \
