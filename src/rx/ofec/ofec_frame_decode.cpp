...
matrix::Matrix<LLR> ofec_decode_llr_plain(const matrix::Matrix<LLR>& llr_mat, const newcode::Params& p,
...
template <typename LLR>
matrix::Matrix<LLR> ofec_decode_llr_ebchPF(const matrix::Matrix<LLR>& llr_mat, const newcode::Params& p,
                                   std::vector<TileEarlyStopCounter>* tile_stats,
                                   bool normalize_extrinsic,
                                   const matrix::Matrix<float>* tx_llr_ref)
{
